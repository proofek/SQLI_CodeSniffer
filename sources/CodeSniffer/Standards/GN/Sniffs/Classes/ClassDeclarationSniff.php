...
/**
 * GN_Sniffs_Classes_ClassDeclarationSniff
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class GN_Sniffs_Classes_ClassDeclarationSniff implements SQLI_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($stackPtr !== false) {
            ...
            $phpcsFile->addEvent(
                        'MULTIPLE_CLASS_OR_INTERFACE_IN_SINGLE_FILE', 
                        array(),
                        $stackPtr
            );
        }
