...
/**
 * GNNew_Sniffs_Whitespace_ScopeClosingBraceSniff.
 * Stripped version of Zend_Sniffs_Whitespace_ScopeClosingBraceSniff.
 *
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class GNNew_Sniffs_Whitespace_ScopeClosingBraceSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$lastContent]['line'] === $tokens[$scopeEnd]['line']) {
		    $phpcsFile->addError('La fermeture d\'un bloc se fait sur une nouvelle ligne', $scopeEnd, 'OneLineScopeClosingbrace');
            return;
        }
