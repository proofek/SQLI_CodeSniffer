...
class GNNew_Tests_NamingConventions_ValidClassNameUnitTest extends AbstractSQLISniffUnitTest
{
    ...
    public function getEventList($testFile='')
    {
        switch ($testFile) {
	        case 'ValidClassNameUnitTest.1.inc':
	            $events1[] = new SQLI_CodeSniffer_Event(2, 1, 'NameStartLetterValidClass');	            
