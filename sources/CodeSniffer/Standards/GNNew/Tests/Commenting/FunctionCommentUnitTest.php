...
class GNNew_Tests_Commenting_FunctionCommentUnitTest extends AbstractSQLISniffUnitTest
{
    ...
    public function getEventList($testFile='')
    {
        switch ($testFile) {
        	...
        	case 'FunctionCommentUnitTest.3.inc':
	            $events3[] = new SQLI_CodeSniffer_Event(3, 1, 'MissingShortDescFunctionComment');	            
        	...
        	case 'FunctionCommentUnitTest.8.inc':
	            $events8[] = new SQLI_CodeSniffer_Event(7, 1, 'OneSpaceLongestTypeFunctionComment');	            
	        ...
	        case 'FunctionCommentUnitTest.10.inc':
	            $events10[] = new SQLI_CodeSniffer_Event(6, 1, 'BlankLineTagsFunctionComment');	            
