...
/**
 * ZF_Sniffs_PHP_DisallowShortOpenTagSniff
 *
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZF_Sniffs_PHP_DisallowShortOpenTagSniff implements SQLI_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($openTag['content'] === '<?') {
            ...
            $phpcsFile->addError($error, $stackPtr, 'NoShortOpenTag');
        }
    }
}
