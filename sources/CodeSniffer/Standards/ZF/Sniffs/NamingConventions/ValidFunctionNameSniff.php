...
/**
 * ZF_Sniffs_NamingConventions_ValidFunctionNameSniff
 *
    ...
    public function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (preg_match('|^__|', $methodName) !== 0) {
            ...
            if (in_array($magicPart, $this->_magicMethods) === false) {
                 ...
                 $phpcsFile->addError($error, $stackPtr, 'MethodNamePrefix');
            }
        ...
        if ($isPublic === false and $methodName{0} !== '_') {
            ...
            $phpcsFile->addError($error, $stackPtr, 'PrivateMethodNamePrefix');
            return;
        }
    ...
    public function processTokenOutsideScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (preg_match('|^__|', $functionName) !== 0) {
            ...
            if (in_array($magicPart, $this->_magicFunctions) === false) {
                 ...
                 $phpcsFile->addError($error, $stackPtr, 'FunctionNamePrefix');
            }
        ...
        if ($packagePart !== '') {
            ...
            if ($functionName{0} !== strtoupper($functionName{0})) {
                ...
                $phpcsFile->addError($error, $stackPtr, 'PackageFunctionNameStartsWithCapitalLetter');
                return;
            }
        }
        ...
        if (trim($camelCapsPart) === '') {
            ...
            $phpcsFile->addError($error, $stackPtr, 'FunctionNameValid');
            return;
        }
