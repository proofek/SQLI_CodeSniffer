...
/**
 * ZF_Sniffs_Functions_FunctionDeclarationArgumentSpacingSniff.
 *
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZF_Sniffs_Functions_FunctionDeclarationArgumentSpacingSniff implements SQLI_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        while ($nextParam !== false) {
            ...
            if ($nextCode === T_EQUAL) {
                ...
                if ($content !== ' ') {
                    ...
                    $phpcsFile->addError($error, $nextToken, 'SpaceBetweenArgumentAndEqualSignFunctionDeclaration');
                }
                ...
                if ($content !== ' ') {
                    ...
                    $phpcsFile->addError($error, $nextToken, 'SpaceBetweenDefaultValueAndEqualSignFunctionDeclaration');
                }
            }
            ...
            if ($nextComma !== false) {
                ...
                if ($tokens[($nextComma - 1)]['code'] === T_WHITESPACE) {
                    ...
                    $phpcsFile->addError($error, $nextToken, 'NoSpaceBetweenArgumentAndCommaFunctionDeclaration');
                }
            }
                ...
                if ($whitespace['code'] === T_WHITESPACE) {
                    ...
                    if ($nextToken !== $nextParam) {
                        ...
                        if ($gap !== 1) {
                            ...
                            $phpcsFile->addError($error, $nextToken, 'SpaceBetweenTypeHintAndArgumentFunctionDeclaration');
                        }

                        if ($tokens[($comma + 1)]['code'] !== T_WHITESPACE) {
                            $error = "Expected 1 space between comma and type hint \"$hint\"; 0 found";
                            $phpcsFile->addError($error, $nextToken, 'SpaceBetweenCommaAndTypeHintFunctionDeclaration');
                        } else {
                        ...
                        $phpcsFile->addError($error, $nextToken, 'SpaceBetweenCommaAndArgumentFunctionDeclaration');
                    }
                } else {
                ...
                if ($whitespace['code'] === T_WHITESPACE) {
                    ...
                    if ($nextToken !== $nextParam) {
                        ...
                        if ($tokens[($bracket + 1)]['code'] === T_WHITESPACE) {
                            ...
                            $phpcsFile->addError($error, $nextToken, 'NoSpaceBetweenOpeningBracketAndTypeHintFunctionDeclaration');
                        }
                    } else {
                        $error = "Expected 0 spaces between opening bracket and argument \"$arg\"; $gap found";
                        $phpcsFile->addError($error, $nextToken, 'NoSpaceBetweenOpeningBracketAndArgumentFunctionDeclaration');
                    }
                }
            }
        ...
        if (empty($params) === true) {
            ...
            if (($closeBracket - $openBracket) !== 1) {
                ...
                $phpcsFile->addError($error, $stackPtr, 'NoSpaceBetweenBracketsFunctionDeclaration');
            }
            ...
            $phpcsFile->addError($error, $closeBracket, 'NoSpaceBetweenArgumentAndClosingBracketFunctionDeclaration');
        }
    }
}
