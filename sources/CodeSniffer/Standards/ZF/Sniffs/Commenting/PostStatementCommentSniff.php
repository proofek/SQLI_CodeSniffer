...
/**
 * ZF_Sniffs_Commenting_PostStatementCommentSniff
 *
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZF_Sniffs_Commenting_PostStatementCommentSniff implements SQLI_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $phpcsFile->addError($error, $stackPtr, 'NoCommentsAfterStatementsOrBrackets');
    }
}
