...
/**
 * ZF_Sniffs_WhiteSpace_OperatorSpacingSniff.
 *
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZF_Sniffs_WhiteSpace_OperatorSpacingSniff implements SQLI_CodeSniffer_Sniff
{
    /**
        ...
        if ($tokens[$stackPtr]['code'] === T_BITWISE_AND) {
            ...
            if ($phpcsFile->isReference($stackPtr) === false) {
                ...
                if ($tokens[($stackPtr - 1)]['code'] !== T_WHITESPACE) {
                    ...
                    $phpcsFile->addError($error, $stackPtr, 'SpaceBeforeOperator');
                } else {
                ...
                if ($tokens[($stackPtr + 1)]['code'] !== T_WHITESPACE) {
                    ...
                    $phpcsFile->addError($error, $stackPtr, 'SpaceAfterOperator');
                } else {
                    if (strlen($tokens[($stackPtr + 1)]['content']) !== 1) {
                        $found = strlen($tokens[($stackPtr + 1)]['content']);
