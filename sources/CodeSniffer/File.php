...
/**
 * A SQLI_CodeSniffer_File object represents a PHP source file, the tokens
 * associated with it and the events raised by file analysis
 *
 * All methods are duplicated for many members and function are private
 *
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class SQLI_CodeSniffer_File extends PHP_CodeSniffer_File
{
    ...
    /**
     * Events raised from SQLI_CodeSniffer_Sniffs.
     *
     * @var SQLI_CodeSniffer_EventList
     */
    protected $_events;
    ...
    public function __construct($file, array $listeners, array $tokenizers)
    {
        ...
        $this->_events    = new SQLI_CodeSniffer_EventList();
    }
